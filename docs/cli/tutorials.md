...
This page contains tutorials for interacting with DG-CLI.
...
DG-CLI uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch DG-CLI and verify the connection

When you launch DG-CLI, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask DG-CLI to perform GitHub actions. For example:
