# DG-CLI file system tools

The DG-CLI provides a comprehensive suite of tools for interacting with the local file system. These tools allow the Gemini model to read from, write to, list, search, and modify files and directories, all under your control and typically with confirmation for sensitive operations.
...
These file system tools provide a foundation for the DG-CLI to understand and interact with your local project context.
