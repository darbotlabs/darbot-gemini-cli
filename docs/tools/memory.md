...
This document describes the `save_memory` tool for the DG-CLI.

## Description

Use `save_memory` to save and recall information across your DG-CLI sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
## How to use `save_memory` with the DG-CLI
...
```
save_memory(fact="The project I'm currently working on is called 'dg-cli'.")
```
