...
export class ClearcutLogger {
  ...
  createLogEvent(name: string, data: object[]): object {
    ...
    data.push({
      gemini_cli_key: EventMetadataKey.DG_CLI_GOOGLE_ACCOUNTS_COUNT,
  ...
  logStartSessionEvent(event: StartSessionEvent): void {
    ...
    const data = [
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_START_SESSION_MODEL,
        value: event.model,
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_SESSION_ID,
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_START_SESSION_SANDBOX,
        value: event.sandbox_enabled.toString(),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_START_SESSION_CORE_TOOLS,
        value: event.core_tools_enabled,
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_START_SESSION_APPROVAL_MODE,
      ...
      {
        gemini_cli_key:
          EventMetadataKey.DG_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        gemini_cli_key:
          EventMetadataKey.DG_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_START_SESSION_MCP_SERVERS,
      ...
      {
        gemini_cli_key:
          EventMetadataKey.DG_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
        value: event.telemetry_log_user_prompts_enabled.toString(),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_SURFACE,
        value: surface,
      },
    ];
  ...
  logNewPromptEvent(event: UserPromptEvent): void {
    const data = [
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_USER_PROMPT_LENGTH,
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_PROMPT_ID,
        value: JSON.stringify(event.prompt_id),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_AUTH_TYPE,
  ...
  logToolCallEvent(event: ToolCallEvent): void {
    const data = [
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_TOOL_CALL_NAME,
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_TOOL_CALL_DECISION,
        value: JSON.stringify(event.decision),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_TOOL_CALL_SUCCESS,
        value: JSON.stringify(event.success),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_TOOL_CALL_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_TOOL_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_TOOL_CALL_ERROR_TYPE,
  ...
  logApiRequestEvent(event: ApiRequestEvent): void {
    const data = [
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_REQUEST_MODEL,
  ...
  logApiResponseEvent(event: ApiResponseEvent): void {
    const data = [
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_PROMPT_ID,
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_RESPONSE_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_RESPONSE_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        gemini_cli_key:
      ...
      {
        gemini_cli_key:
          EventMetadataKey.DG_CLI_API_RESPONSE_THINKING_TOKEN_COUNT,
  ...
  logApiErrorEvent(event: ApiErrorEvent): void {
    const data = [
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_ERROR_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_PROMPT_ID,
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_ERROR_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_API_ERROR_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_AUTH_TYPE,
  ...
  logLoopDetectedEvent(event: LoopDetectedEvent): void {
    const data = [
      ...
      {
        gemini_cli_key: EventMetadataKey.DG_CLI_LOOP_DETECTED_TYPE,
