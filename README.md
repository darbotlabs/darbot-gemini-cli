...
You are now ready to use the DG-CLI!
...
```sh
git clone https://github.com/darbotlabs/darbot-gemini-cli
...
Start by `cd`ing into an existing or newly-cloned repository and running `dg-cli`.
